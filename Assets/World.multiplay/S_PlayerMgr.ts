...
export default class S_PlayerMgr {
    ...
    public onCreate(options: SandboxOptions)
    {
        this.m_SandBox.onMessage("onChangedTransform", (client, message) => {
        ...
        this.m_SandBox.onMessage("onChangedState", (client, message) => {
            const player = this.m_SandBox.state.players.get(client.sessionId);
    ...
    public async onJoin(client: SandboxPlayer)
    {
        ...
        this.m_SandBox.state.players.set(client.sessionId, player);
    }
    public onLeave(client: SandboxPlayer, consented?: boolean) 
    {
        ...
        this.m_SandBox.state.players.delete(client.sessionId);
    }
}